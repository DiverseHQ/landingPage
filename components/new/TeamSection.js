    ...
    <div className="flex flex-col ">
      ...
      <section className="flex  items-center justify-center p-3 flex-wrap ">
        <div className="flex flex-row border rounded p-1 m-2">
          <img src="https://cdn.discordapp.com/attachments/1014407377056968754/1043118148926312528/WFDFwC_I_400x400.jpg" alt="avatar" className="w-20 h-20 border rounded-full" />
        ...
        <div className="flex flex-row border rounded p-1 m-2">
          <img src="/Kirrttiraj.jpg" alt="avatar" className="w-20 h-20 border rounded-full" />
          <div className="flex flex-col justify-center p-3 mx-2">
